...
class Solution
{
    public static void solve(Node root, int sum, int target, ArrayList<Integer> temp, ArrayList<ArrayList<Integer>> result) {
        if (root == null) {
            return;
        }
        ...
        solve(root.left, sum, target, temp, result);
        solve(root.right, sum, target, temp, result);
